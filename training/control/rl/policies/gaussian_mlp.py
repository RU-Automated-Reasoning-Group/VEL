...
class MLP:
    def __init__(self, env_spec,
        ...
        # Policy network
        # ------------------------
        self.model = FCNetwork(self.n, self.m, hidden_sizes, nonlinearity=nonlinearity, bias=bias)
        # make weights small
        ...
        # Old Policy network
        # ------------------------
        self.old_model = FCNetwork(self.n, self.m, hidden_sizes, nonlinearity=nonlinearity, bias=bias)
