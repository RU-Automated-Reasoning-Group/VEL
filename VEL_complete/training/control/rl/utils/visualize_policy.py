...
from control.rl.policies.gaussian_mlp import MLP

DESC = '''
Helper script to visualize policy (in control.rl format).\n
USAGE:\n
    Visualizes policy on the env\n
    $ python utils/visualize_policy --env_name control.rl_swimmer-v0 --policy my_policy.pickle --mode evaluation --episodes 10 \n
'''
